...
# Example usage
plots <- generate_plots() # For All India statistics
...
print(plots[[10]])# rural - MPCE 
print(plots[[11]])# rural - population 
print(plots[[12]])# urban - MPCE
print(plots[[13]])# urban - population
